...
import { Lock, Wallet, Activity, BarChart3, History, ArrowRight } from 'lucide-react';
                      ...
                      <div className="w-40 h-40 rounded-full bg-gradient-radial from-arthanet-blue/20 to-transparent flex items-center justify-center">
                        <div className="w-32 h-32 rounded-full glass-card border border-arthanet-blue/30 flex items-center justify-center">
                          <div className="text-center">
                            ...
                            <div className="text-arthanet-blue text-sm mt-1">Connect Wallet</div>
                          </div>
                        </div>
                      </div>
              ...
              >
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div 
                      key={index} 
                      className="flex items-start p-4 glass-card rounded-lg hover:bg-white/5 transition-colors"
